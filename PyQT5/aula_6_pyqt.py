...
class Janela(QMainWindow):
    def __init__(self):
        ...
        botao_caixa.move(550, 200)  # esquerda - topo
        botao_caixa.resize(150, 80)  # largura - tamanho do botao
        botao_caixa.setStyleSheet('QPushButton{background-color:#18f72e; font:bold; font-size: 20px}')
        ...
        botao2.move(350, 200)  # esquerda - topo
        ...
        self.label_caixa = QLabel(self)     # caixa de texto
        self.label_caixa.setText("Digitou: ")
        self.label_caixa.move(450, 100)
        self.label_caixa.resize(260, 30)
    ...
    def mostra_texto(self):
        ...
        self.label_caixa.setText(f"Digitou: {conteudo}")
